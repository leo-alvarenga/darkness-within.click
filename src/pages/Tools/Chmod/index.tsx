...
function Chmod() {
  ...
  return (
    <Page>
      <h1 className="text-4xl max-lg:text-xl font-bold">
        {t("page.tools.chmod.title")}
      </h1>
      <p className="text-xl max-lg:text-md">
        {t("page.tools.chmod.description")}
      </p>

      <ChmodTable
        onChange={(numeric, symbolic) => setCode({ numeric, symbolic })}
      />
